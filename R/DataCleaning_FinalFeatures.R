...
features_2013 <- c(
  "cc_ckd", "cc_cvd_any", "cc_diabetes", "cc_cvd_ascvd",
  "cc_acr", "demo_race",
  "LBDHDD", "LBXRBCSI", "cc_smoke", "cc_egfr",
  "demo_gender", "LBDMONO",
  "LBXBSE", "weight_change", "INDFMMPI", "LBDBANO",
  "BMXBMI", "demo_age_years", "LBXBPB", "LBXWBCSI",
  "SEQN", "svy_weight_mec", 
  "svy_psu", "svy_strata", "bp_control_jnc7")
...
features_2015 <- c(
  "cc_ckd", "cc_cvd_any", "demo_gender", 
  "cc_cvd_mi", "cc_smoke", "weight_change", "demo_race",
  "LBDEONO", "LBXBSE", "cc_egfr", "URXUMS",
  "BMXBMI", "cc_diabetes",
  "cc_acr", "LBXBPB", "LBXCOT", "LBDBANO","cc_cvd_ascvd", "URXUCR.x.x.x",
  "INDFMMPI","SEQN", "svy_weight_mec", 
  "svy_psu", "svy_strata", "bp_control_jnc7")
...
features_2017 <- c(
  "cc_ckd", "demo_race", "BMXBMI",
  "cc_diabetes", "LBXBPB", "cc_egfr",
  "cc_acr", "URXUMS",
  "URXUCR.x.x.x", "LBXTHG", "LBDHDD",
  "LBXRBCSI", "LBXBSE",
  "LBDMONO", "cc_smoke", "INDFMMPI",
  "LBXHGB", "cc_cvd_any",
  "LBDEONO", "cc_hba1c", "SEQN", "svy_weight_mec", 
  "svy_psu", "svy_strata", "bp_control_jnc7"
)
